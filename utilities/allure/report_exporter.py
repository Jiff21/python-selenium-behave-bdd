import os
import requests
from settings import  ALLURE_REPORT_HUB_URL, ALLURE_PROJECT_NAME
from settings import ALLURE_HUB_CLIENT_ID, QA_DIRECTORY
from settings import SLACK_CHANNEL
from utilities.oauth.service_account_auth import make_iap_request
from utilities.slack.webhook import SlackMessage
